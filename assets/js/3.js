...
function(A) {
    ...
    function t() {
        v().init(), -1 < navigator.appVersion.toLowerCase().indexOf("mac") && edgtf.body.hasClass("edgtf-smooth-scroll") && edgtf.body.removeClass("edgtf-smooth-scroll"), s().init(), A("#edgtf-back-to-top").on("click", function(e) {
                ...
                e.length && e.each(function() {
                    ...
                    e.on("submit", function(e) {
                        ...
                        return f.append("data", d), A.ajax({
                            ...
                            success: function(e) {
                                var t;
                                t = JSON.parse(e), edgtf.modules.socialLogin.edgtfRenderAjaxResponseMessage(t), "success" === t.status ? (o.html(n), window.location = t.redirect) : o.html(a)
                            }
                        }), !1
                    })
                })
            ...
            function() {
                if (edgtf.body.hasClass("edgtf-scroll-to-content") && !edgtf.htmlEl.hasClass("touch")) {
                    var e, t, a, d, o = A(".edgtf-slider"),
                        i = o.find(".rev_slider"),
                        n = !1,
                        s = !1,
                        r = function() {
                            e = o.height(), t = o.offset().top, a = e - t, d = e + t
                        };
                    r(), o.on("mousewheel", function(e) {
                        ! function(e) {
                            s = e.deltaY < 0
                        }(e)
                    }), document.querySelector(".edgtf-slider").addEventListener("wheel", function(e) {
                        edgtf.scroll < a && s && (l(), n || (n = !0, A("html, body").stop().animate({
                            scrollTop: d
            ...
            function() {
                if (edgtf.body.hasClass("edgtf-smooth-page-transitions")) {
                    if (edgtf.body.hasClass("edgtf-smooth-page-transitions-preloader")) {
                        ...
                        t.fadeOut(500), A(window).on("bind", "pageshow", function(e) {
                            e.originalEvent.persisted && t.fadeOut(500)
                        })
                    }
                    if (edgtf.body.hasClass("edgtf-smooth-page-transitions-fadeout")) A("a").on("click", function(e) {
                        var t = A(this);
                        (t.parents(".edgtf-shopping-cart-dropdown").length || t.parent(".product-remove").length) && t.hasClass("remove") || 1 === e.which && 0 <= t.attr("href").indexOf(window.location.host) && void 0 === t.data("rel") && void 0 === t.attr("rel") && !t.hasClass("lightbox-active") && (void 0 === t.attr("target") || "_self" === t.attr("target")) && t.attr("href").split("#")[0] !== window.location.href.split("#")[0] && (e.preventDefault(), A(".edgtf-wrapper-inner").fadeOut(800, "easeOutQuint", function() {
    ...
    function l() {
        window.addEventListener && window.addEventListener("DOMMouseScroll", o, !1), window.onmousewheel = document.onmousewheel = o, document.onkeydown = i
    }

    function f() {
        window.removeEventListener && window.removeEventListener("DOMMouseScroll", o, !1), window.onmousewheel = document.onmousewheel = document.onkeydown = null
    }
    ...
    function n(e) {
    ...
    }(edgtf.modules.common = e).edgtfFluidVideo = u, e.edgtfEnableScroll = f, e.edgtfDisableScroll = l, e.edgtfOwlSlider = b, e.edgtfInitParallax = z, e.edgtfInitSelfHostedVideoPlayer = g, e.edgtfSelfHostedVideoSize = c, e.edgtfPrettyPhoto = h, e.edgtfStickySidebarWidget = y, e.getLoadMoreData = function(e) {
        var t = e.data(),
            a = {};
        ...
        return a
    }, e.setFixedImageProportionSize = p, e.edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowResize = d, A(document).ready(t), A(window).load(a), A(window).resize(d);
    var s = function() {
        function n(t) {
        ...
        var t = function(e) {
                var t, a = A(".edgtf-main-menu a, .edgtf-mobile-nav a, .edgtf-fullscreen-menu a"),
                    d = e,
                    o = "" !== d ? A('[data-edgtf-anchor="' + d + '"]') : "";
                if ("" !== d && 0 < o.length) {
                    var i = o.offset().top;
                    return t = i - s(i) - edgtfGlobalVars.vars.edgtfAddForAdminBar, a.length && a.each(function() {
                        var e = A(this); - 1 < e.attr("href").indexOf(d) && n(e)
        ...
        return {
            init: function() {
                A("[data-edgtf-anchor]").length && (edgtf.document.on("click", ".edgtf-main-menu a, .edgtf-fullscreen-menu a, .edgtf-btn, .edgtf-anchor, .edgtf-mobile-nav a", function() {
                    ...
                    var t, e = A("[data-edgtf-anchor]"),
                        a = window.location.href.split("#")[0];
                    "/" !== a.substr(-1) && (a += "/"), e.waypoint(function(e) {
                        "down" === e && (t = 0 < A(this.element).length ? A(this.element).data("edgtf-anchor") : A(this).data("edgtf-anchor"), n(A("a[href='" + a + "#" + t + "']")))
                    }, {
                        offset: "50%"
                    }), e.waypoint(function(e) {
                        "up" === e && (t = 0 < A(this.element).length ? A(this.element).data("edgtf-anchor") : A(this).data("edgtf-anchor"), n(A("a[href='" + a + "#" + t + "']")))
                    }, {
                        offset: function() {
    ...
    function p(e, t, a, d) {
        if (e.hasClass("edgtf-masonry-images-fixed") || !0 === d) {
            ...
            n.css("height", i), r.css("height", Math.round(2 * (i + o))), 680 < edgtf.windowWidth ? (s.css("height", i), l.css("height", Math.round(2 * (i + o)))) : (s.css("height", Math.round(i / 2)), l.css("height", i))
        }
    }
    var v = function() {
    ...
    function b() {
        ...
        e.length && e.each(function() {
            var a, i = A(this),
                ...
                w = !1,
                C = !1,
                x = !!i.hasClass("edgtf-list-is-slider"),
                k = x ? i.parent() : i,
                S = !0;
            if (void 0 === i.data("number-of-items") || !1 === i.data("number-of-items") || x || (d = i.data("number-of-items")), void 0 !== k.data("number-of-columns") && !1 !== k.data("number-of-columns") && x) switch (k.data("number-of-columns")) {
                case "one":
                    d = 1;
                    break;
                case "two":
            ...
            "no" === k.data("enable-loop") && (o = !1), "no" === k.data("enable-autoplay") && (n = !1), "no" === k.data("enable-autoplay-hover-pause") && (s = !1), void 0 !== k.data("slider-speed") && !1 !== k.data("slider-speed") && (r = k.data("slider-speed")), void 0 !== k.data("slider-speed-animation") && !1 !== k.data("slider-speed-animation") && (l = k.data("slider-speed-animation")), void 0 !== k.data("slider-margin") && !1 !== k.data("slider-margin") ? f = "no" === k.data("slider-margin") ? 0 : k.data("slider-margin") : i.parent().hasClass("edgtf-huge-space") ? f = 60 : i.parent().hasClass("edgtf-large-space") ? f = 50 : i.parent().hasClass("edgtf-medium-space") ? f = 40 : i.parent().hasClass("edgtf-normal-space") ? f = 30 : i.parent().hasClass("edgtf-small-space") ? f = 20 : i.parent().hasClass("edgtf-tiny-space") && (f = 10), "yes" === k.data("slider-padding") && (h = !0, u = parseInt(.28 * i.outerWidth()), f = 50), "yes" === k.data("enable-center") && (m = !0), "yes" === k.data("enable-auto-width") && (p = !0), void 0 !== k.data("slider-animate-in") && !1 !== k.data("slider-animate-in") && (v = k.data("slider-animate-in")), void 0 !== k.data("slider-animate-out") && !1 !== k.data("slider-animate-out") && (y = k.data("slider-animate-out")), "no" === k.data("enable-navigation") && (b = !1), "yes" === k.data("enable-pagination") && (w = !0), "yes" === k.data("enable-thumbnail") && (C = !0), C && !w && (w = !0, e.addClass("edgtf-slider-hide-pagination")), b && w && i.addClass("edgtf-slider-has-both-nav"), t <= 1 && (w = b = n = o = !1);
            var _ = 2,
                T = 3,
                I = d,
                O = d;
            d < 3 && (T = _ = d), 4 < d && (I = 4), 5 < d && (O = 5), (h || 30 < f) && (g = 20, c = 30), 0 < f && f <= 30 && (c = g = f);

            function D() {
                if (x && i.hasClass("edgtf-ps-full-height")) {
                    s = !1;
                    var t, e = i.find(".owl-item"),
                        a = A(".edgtf-page-header").outerHeight(),
                        d = A(".edgtf-title-holder").outerHeight(),
                        o = A(".edgtf-content-bottom").outerHeight();
                    A(".edgtf-header-sliding").length && (a = A(".edgtf-main-menu").outerHeight());
                    i.hasClass("edgtf-ps-full-height-decreased") ? (edgtf.windowWidth <= 1024 && (a = A(".edgtf-mobile-header").outerHeight()), 600 <= edgtf.windowWidth ? e.height(edgtf.windowHeight - a - d - o - 60) : e.height(edgtf.windowHeight)) : e.height(edgtf.windowHeight), e.each(function() {
                        var e = A(this);
            ...
            if (A(window).resize(function() {
                    ...
                    e = i.owlCarousel({
                        ...
                        onInitialize: function() {
                            i.css("visibility", "visible"), z(), C && a.find(".edgtf-slider-thumbnail-item:first-child").addClass("active")
                        },
                        onInitialized: function() {
                            D(), x && i.hasClass("edgtf-ps-full-height") && i.mousewheel(function(e) {
                                S && (e.preventDefault(), e.deltaY < 0 ? i.trigger("next.owl.carousel", [600]) : i.trigger("prev.owl.carousel", [600]))
                ...
                "" !== H && a.addClass("edgtf-slider-columns-" + H), a.find(".edgtf-slider-thumbnail-item").on("click", function() {
...
function(f) {
                    ...
                    e.each(function() {
                        ...
                        ! function(e, o) {
                            e.find(".edgtf-post-excerpt-holder").each(function() {
                                var e, t, a, d = f(this);
                                "slider" === o && (t = (e = d.closest(".edgtf-item-text-wrapper")).closest(".owl-item"), a = d.outerHeight(!0) + parseInt(e.css("paddingTop"))), "list" === o && (t = (e = d.closest(".edgtf-bli-content")).closest(".edgtf-bl-item"), a = d.outerHeight()),
                                    function(e, t, a, d) {
                                        t.css({
                    ...
                    f.ajax({
                        ...
                        success: function(e) {
                            ...
                            a.waitForImages(function() {
                                a.hasClass("edgtf-grid-masonry-list") ? (r(o, i, t), edgtf.modules.common.setFixedImageProportionSize(a, a.find("article"), o.find(".edgtf-masonry-grid-sizer").width())) : l(o, i, t), setTimeout(function() {
    ...
    }(edgtf.modules.blog = e).edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowScroll = d, f(document).ready(t), f(window).load(a), f(window).scroll(d)
}(jQuery),
function(o) {
    "use strict";
    var e = {};
        ...
        d(), setTimeout(function() {
            r(".edgtf-drop-down > ul > li").each(function() {
                ...
                n.find(".second").length && n.waitForImages(function() {
                    ...
                    if (edgtf.menuDropdownHeightSet || e.height(0), navigator.userAgent.match(/(iPod|iPhone|iPad)/)) n.on("touchstart mouseenter", function() {
                        e.css({
                            height: t,
                            overflow: "visible",
                            visibility: "visible",
                        ...
                        n.hoverIntent(o)
                    } else if (edgtf.body.hasClass("edgtf-dropdown-slide-from-bottom")) o = {
                        interval: 0,
                        over: function() {
                            setTimeout(function() {
                                e.addClass("edgtf-drop-down-start").css({
    ...
    function t() {
        ! function() {
            var d, o = f(".edgtf-wrapper"),
                i = f(".edgtf-side-menu"),
                n = f("a.edgtf-side-menu-button-opener"),
                s = !1,
                r = !1,
                l = !1;
            ...
            f("a.edgtf-side-menu-button-opener, a.edgtf-close-side-menu").on("click", function(e) {
                if (e.preventDefault(), n.hasClass("opened")) {
                    if (n.removeClass("opened"), edgtf.body.removeClass(d), l) var t = setTimeout(function() {
                        i.css({
                            visibility: "hidden"
                        }), clearTimeout(t)
                    }, 400)
                } else {
                    n.addClass("opened"), edgtf.body.addClass(d), s && f(".edgtf-wrapper .edgtf-cover").on("click", function() {
                        edgtf.body.removeClass("edgtf-right-side-menu-opened"), n.removeClass("opened")
                    }), l && i.css({
                        visibility: "visible"
                    });
                    var a = f(window).scrollTop();
                    f(window).scroll(function() {
                        if (400 < Math.abs(edgtf.scroll - a) && (edgtf.body.removeClass(d), n.removeClass("opened"), l)) var e = setTimeout(function() {
                            i.css({
                                visibility: "hidden"
                            }), clearTimeout(e)
                        }, 400)
                ...
                r && (e.stopPropagation(), o.on("click", function() {
                    e.preventDefault(), n.removeClass("opened"), edgtf.body.removeClass("edgtf-side-menu-open")
                }))
            })
        }(),
        function() {
    ...
    function t() {
        r(document).on("click", ".edgtf-quantity-minus, .edgtf-quantity-plus", function(e) {
            ...
            function() {
                ...
                e.length && (e.children("a").attr("data-rel", "prettyPhoto[woo_single_pretty_photo]"), "function" == typeof edgtf.modules.common.edgtfPrettyPhoto && edgtf.modules.common.edgtfPrettyPhoto())
            }()
        ...
        var e = h(".edgtf-blog-list-holder"),
            o = function(a, e) {
                ...
                if (t.blog_load_more_id = s.attr("name").substring(s.attr("name").length - 4, s.attr("name").length), t.blog_load_more_nonce = s.val(), d <= o) {
                    a.hasClass("edgtf-bl-pag-standard-shortcodes") ? (n.addClass("edgtf-showing edgtf-standard-pag-trigger"), a.addClass("edgtf-bl-pag-standard-shortcodes-animate")) : n.addClass("edgtf-showing");
                    ...
                    h.ajax({
                        ...
                        success: function(e) {
                            ...
                            a.hasClass("edgtf-bl-pag-standard-shortcodes") ? (l(a, o, d), a.waitForImages(function() {
                                a.hasClass("edgtf-bl-masonry") ? f(a, i, n, t) : (g(a, i, n, t), "function" == typeof edgtf.modules.common.edgtfStickySidebarWidget && edgtf.modules.common.edgtfStickySidebarWidget().reInit())
                            })) : a.waitForImages(function() {
                                a.hasClass("edgtf-bl-masonry") ? c(i, n, t) : (u(i, n, t), "function" == typeof edgtf.modules.common.edgtfStickySidebarWidget && edgtf.modules.common.edgtfStickySidebarWidget().reInit())
            ...
            l = function(e, t, a) {
                ...
                o.removeClass("edgtf-pag-active"), o.eq(a - 1).addClass("edgtf-pag-active"), i.data("paged", a - 1), n.data("paged", a + 1), 1 < a ? i.css({
                    opacity: "1"
                }) : i.css({
                    opacity: "0"
                }), a === t ? n.css({
...
function(e) {
    ...
    function o() {
        if (edgtf.body.hasClass("edgtf-header-divided")) {
            var t = e(".edgtf-menu-area, .edgtf-sticky-header"),
                ...
                n = 0;
            t.waitForImages(function() {
                t.find(".edgtf-grid").length && (a = t.find(".edgtf-grid").outerWidth()), o.length && parseInt(o.css("paddingLeft"), 10), i.length && (n = i.width() / 2);
    ...
    }(edgtf.modules.headerDivided = t).edgtfOnDocumentReady = a, t.edgtfOnWindowResize = d, e(document).ready(a), e(window).resize(d)
}(jQuery),
function(n) {
    "use strict";
    var e = {};
    ...
    function t() {
        a().init()
    }(edgtf.modules.headerVertical = e).edgtfOnDocumentReady = t, n(document).ready(t);
    var a = function() {
        function e() {
                ...
                t.length && (function() {
                    ...
                    e.hasClass("edgtf-vertical-dropdown-below") ? (i = e.find("ul li.menu-item-has-children")).each(function() {
                        ...
                        d.on("click tap", function(e) {
                            e.preventDefault(), e.stopPropagation(), t.is(":visible") ? (n(a).removeClass("open"), t.slideUp(o)) : (d.parent().parent().children().hasClass("open") && d.parent().parent().parent().hasClass("edgtf-vertical-menu") ? (n(this).parent().parent().children().removeClass("open"), n(this).parent().parent().children().find(" > .second").slideUp(o)) : (n(this).parents("li").hasClass("open") || (i.removeClass("open"), i.find(" > .second, > ul").slideUp(o)), n(this).parent().parent().children().hasClass("open") && (n(this).parent().parent().children().removeClass("open"), n(this).parent().parent().children().find(" > .second, > ul").slideUp(o))), n(a).addClass("open"), t.slideDown("fast"))
                        })
                        ...
                        Modernizr.touch ? n(this).find("> a").on("click tap", function(e) {
                            e.preventDefault(), e.stopPropagation(), t.hasClass("edgtf-float-open") ? (t.removeClass("edgtf-float-open"), n(a).removeClass("open")) : (n(this).parents("li").hasClass("open") || (d.removeClass("open"), o.removeClass("edgtf-float-open")), t.addClass("edgtf-float-open"), n(a).addClass("open"))
                        }) : n(this).hoverIntent({
                            over: function() {
                                t.addClass("edgtf-float-open"), n(a).addClass("open")
                            },
                            out: function() {
                                t.removeClass("edgtf-float-open"), n(a).removeClass("open")
                            },
                            timeout: 300
                        })
                    }))
    ...
    function t() {
        ! function() {
            ...
            t.length && n.length && t.on("tap click", function(e) {
                e.stopPropagation(), e.preventDefault(), n.is(":visible") ? (n.slideUp(450, "easeInOutQuint"), t.removeClass("edgtf-mobile-menu-opened")) : (n.slideDown(450, "easeInOutQuint"), t.addClass("edgtf-mobile-menu-opened"))
            });
            e.length && e.each(function() {
                var o = s(this),
                    i = n.outerHeight();
                o.on("tap click", function(e) {
                    ...
                    if (t.hasClass("has_sub")) {
                        ...
                        d.is(":visible") ? (d.slideUp(450, "easeInOutQuint"), t.removeClass("edgtf-opened"), n.stop().animate({
                            height: i
            ...
            s(".edgtf-mobile-nav a, .edgtf-mobile-logo-wrapper a").on("click tap", function(e) {
                "http://#" !== s(this).attr("href") && "#" !== s(this).attr("href") && (n.slideUp(450, "easeInOutQuint"), t.removeClass("edgtf-mobile-menu-opened"))
            })
        }(), d(),
            function() {
                ...
                if (edgtf.body.hasClass("edgtf-sticky-up-mobile-header")) {
                    ...
                    d = e + edgtfGlobalVars.vars.edgtfAddForAdminBar, s(window).scroll(function() {
    ...
    function t() {
        1024 < edgtf.windowWidth && function() {
            var t, e, a = g(".edgtf-page-header"),
                ...
                i = o.children(".edgtf-menu-area").outerHeight(),
                n = g(".edgtf-slider"),
            ...
            switch (!0) {
                ...
                case edgtf.body.hasClass("edgtf-fixed-on-scroll"):
                    ...
                    var f = function() {
                        edgtf.scroll <= r ? (o.removeClass("fixed"), edgtf.body.removeClass("edgtf-fixed-header-appear"), a.css("margin-bottom", "0")) : (o.addClass("fixed"), edgtf.body.addClass("edgtf-fixed-header-appear"), a.css("margin-bottom", i + "px"))
                    };
...
function(l) {
    ...
    function t() {
        ! function() {
            ...
            e.length && e.each(function() {
                var d, o, e = l(this),
                    i = e.find(".edgtf-match-list-holder"),
                    n = e.find(".edgtf-match-list-load-more a"),
                    s = n.text(),
                    r = edgtfGlobalVars.vars.edgtfPtfLoadMoreMessage;
                void 0 !== i.data("max-num-pages") && !1 !== i.data("max-num-pages") && (o = i.data("max-num-pages")), n.on("click", function(e) {
                    var t = function(e) {
                        var t = {
                            orderBy: "",
                            order: "",
                    ...
                    if (d = t.nextPage, n.text(r), e.preventDefault(), e.stopPropagation(), d <= o) {
                        var a = function(e) {
                            return {
    ...
    }(edgtf.modules.match = e).edgtfOnDocumentReady = t, l(document).ready(t)
}(jQuery),
function(r) {
    "use strict";
    var e = {};
        ...
        return {
            init: function() {
                ! function() {
                    ...
                    t.length && d <= o && (0 < edgtf.scroll && i.length && (n = i.height()), edgtf.scroll >= a - n - edgtfGlobalVars.vars.edgtfAddForAdminBar - s ? edgtf.scroll + n + edgtfGlobalVars.vars.edgtfAddForAdminBar + s + d < a + o ? (t.stop().animate({
                    ...
                    function(e) {
                        if (void 0 !== e.data("hover-bg-color")) {
                            ...
                            e.on("mouseenter", {
                                ...
                                button: e,
                                color: d
                            }, t), e.hasClass("edgtf-btn-trapeze-shape") && (e.on("mouseenter", {
...
function(p) {
    ...
    function a() {
        var o, i, n, s, r, l, f, g, c, u, h, e = p(".edgtf-countdown"),
            m = (new Date).getMonth();
        e.length && e.each(function() {
            var e, t, a = p(this).attr("id"),
                d = p("#" + a);
            o = d.data("year"), i = d.data("month"), n = d.data("day"), s = d.data("hour"), r = d.data("minute"), l = d.data("timezone"), f = d.data("month-label"), g = d.data("day-label"), c = d.data("hour-label"), u = d.data("minute-label"), h = d.data("second-label"), e = d.data("digit-size"), t = d.data("label-size"), m !== i && (i -= 1), d.countdown({
...
function(r) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            ...
            }), s.length && (t = '<style type="text/css">' + s + "</style>"), t.length && r("head").append(t), "function" == typeof edgtf.modules.common.edgtfOwlSlider && edgtf.modules.common.edgtfOwlSlider()
        })
...
function(s) {
    ...
    function i(t) {
        ...
        if (t.find(".edgtf-fsis-item").removeClass("edgtf-fsis-content-image-init"), function(e) {
...
function(m) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var e, t, a, d, o, i, n, s, r, l, f = m(this),
                g = !1,
                c = "";
        ...
        e.length && e.each(function() {
            ...
            e.appear(function() {
                ! function(e, t) {
                    ...
                    width: d + "%"
                }, 2e3), e.hasClass("edgtf-pb-percent-floating") && a.css("left", "0%").animate({
                    left: d + "%"
                }, 2e3)
            })
        })
...
function(i) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            ...
            }), e.tabs(), i(".edgtf-tabs a.edgtf-external-link").off("click")
        })
...
function(r) {
    ...
    }(edgtf.modules.textMarquee = e).edgtfInitTextMarquee = a, e.edgtfTextMarqueeResize = d, e.edgtfOnDocumentReady = t, r(document).ready(t)
}(jQuery),
function(l) {
    "use strict";
    var e = {};
    ...
    function a() {
        var n = l(".edgtf-vertical-split-slider"),
            s = !0;
        if (n.length) {
            edgtf.body.hasClass("edgtf-vss-initialized") && (edgtf.body.removeClass("edgtf-vss-initialized"), l.fn.multiscroll.destroy()), n.height(edgtf.windowHeight).animate({
                opacity: 1
            }, 300);
            var r = "";
            edgtf.body.hasClass("edgtf-light-header") ? r = "light" : edgtf.body.hasClass("edgtf-dark-header") && (r = "dark"), n.multiscroll({
                scrollingSpeed: 700,
                ...
                afterRender: function() {
                    f(l(".edgtf-vss-ms-left .edgtf-vss-ms-section:first-child").data("header-style"), r), edgtf.body.addClass("edgtf-vss-initialized");
                    ...
                    n.after(t);
                    for (var o = 0; o < a.length; o++) t.append(l(a[o]).clone(!0)), t.append(l(d[a.length - 1 - o]).clone(!0));
                ...
                onLeave: function(e, t) {
                    "function" == typeof edgtf.modules.progressBar.edgtfInitProgressBars && l(l(".edgtf-vss-ms-left .edgtf-vss-ms-section, .edgtf-vss-ms-right .edgtf-vss-ms-section")[t]).find(".edgtf-progress-bar").length && setTimeout(function() {
                        ...
                        }(n, t), f(l(l(".edgtf-vss-ms-left .edgtf-vss-ms-section")[t - 1]).data("header-style"), r)
                }
            }), edgtf.windowWidth <= 1024 ? l.fn.multiscroll.destroy() : l.fn.multiscroll.build(), l(window).resize(function() {
...
function(u) {
                            ...
                            success: function(e) {
                                ...
                                o.waitForImages(function() {
                                    ...
                                    e ? setTimeout(function() {
                                        edgtf.modules.common.setFixedImageProportionSize(o, i.find("article"), i.find(".edgtf-masonry-grid-sizer").width()), i.isotope("layout").isotope({
                                            filter: n
    ...
    function d() {
        ...
        var e = u(".edgtf-portfolio-list-holder"),
            ...
            l = function(e, t, a, d) {
                t.find("article").remove(), t.append(d), edgtf.modules.common.setFixedImageProportionSize(e, t.find("article"), t.find(".edgtf-masonry-grid-sizer").width()), t.isotope("reloadItems").isotope({
                    sortBy: "original-order"
            ...
            g = function(e, t, a, d) {
                t.append(d), edgtf.modules.common.setFixedImageProportionSize(e, t.find("article"), t.find(".edgtf-masonry-grid-sizer").width()), t.isotope("reloadItems").isotope({
                    sortBy: "original-order"
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var e = f(this),
                ...
                n = 600,
                s = !1;
            if ("no" === t.data("enable-loop") && (a = !1), "no" === t.data("enable-autoplay") && (d = !1), void 0 !== t.data("slider-speed") && !1 !== t.data("slider-speed") && (i = t.data("slider-speed")), void 0 !== t.data("slider-speed-animation") && !1 !== t.data("slider-speed-animation") && (n = t.data("slider-speed-animation")), edgtf.windowWidth < 680 && (s = !0), t.length && o.length) {
                var r = t.owlCarousel({
                        items: 1,
                        loop: a,
                        autoplay: d,
        ...
        ! function() {
            ...
            e.length && e.each(function() {
                var t = u(this),
                    ...
                    f = !1,
                    g = t;
                if ("no" === g.data("enable-loop") && (a = !1), void 0 !== g.data("slider-speed") && !1 !== g.data("slider-speed") && (o = g.data("slider-speed")), void 0 !== g.data("slider-speed-animation") && !1 !== g.data("slider-speed-animation") && (i = g.data("slider-speed-animation")), "yes" === g.data("enable-auto-width") && (n = !0), void 0 !== g.data("slider-animate-in") && !1 !== g.data("slider-animate-in") && (s = g.data("slider-animate-in")), void 0 !== g.data("slider-animate-out") && !1 !== g.data("slider-animate-out") && (r = g.data("slider-animate-out")), "no" === g.data("enable-navigation") && (l = !1), "yes" === g.data("enable-pagination") && (f = !0), l && f && t.addClass("edgtf-slider-has-both-nav"), f) {
                    var c = "#edgtf-testimonial-pagination";
                    u(".edgtf-tsp-item").on("click", function() {
                        t.trigger("to.owl.carousel", [u(this).index(), 300])
                    })
                }
                e <= 1 && (f = l = d = a = !1), t.waitForImages(function() {
                    u(this).owlCarousel({
                        items: 1,
                        loop: a,
                        autoplay: d,
