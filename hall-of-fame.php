...
if($db_found){
	$sql = "SELECT * FROM `palmares` ";
    $result = mysqli_query($db_handle, $sql);
   
   while ($palmare = mysqli_fetch_assoc($result)) {
    $palmares[]=$palmare;
    
   }
   $trophies = sizeof($palmares);
   $year = date("Y");
   $per = "2019 - ".$year;
   $sql = "SELECT * FROM `palmares` WHERE periode = '$per' ORDER BY `palmares`.`datefin` DESC";
   $result = mysqli_query($db_handle, $sql);
  
  while ($palma = mysqli_fetch_assoc($result)) {
   $palmas[]=$palma;
   
  }

  $sql = "SELECT * FROM `palmares` WHERE periode = '2008 - 2011' ORDER BY `palmares`.`datefin` DESC";
  $result = mysqli_query($db_handle, $sql);
 
 while ($palmab = mysqli_fetch_assoc($result)) {
  $palmabs[]=$palmab;
  
 }

 $sql = "SELECT * FROM `palmares` WHERE periode = '2004 - 2007' ORDER BY `palmares`.`datefin` DESC";
 $result = mysqli_query($db_handle, $sql);

while ($palmac = mysqli_fetch_assoc($result)) {
 $palmacs[]=$palmac;
 
}

   $sql = "SELECT * FROM `palmares` WHERE position = 1";
   $result = mysqli_query($db_handle, $sql);
 ...
 if($_GET['delete']==1)
 {
   ...
   $supprimer = "DELETE FROM palmares WHERE idPalmares = '$id'";
   $supression = mysqli_query($db_handle, $supprimer);
 
   echo " <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
   Le palmarès choisi a été supprimé !
...
<head>
	...
	<title>Palmarès - ShockFX Esport</title>
...
<body
						...
						<div class="edgtf-grid">
							<ul id="menu-main-menu-navigation" class="">
								...
								<li id="mobile-menu-item-39"
									class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children edgtf-active-item has_sub">
									<a href="#" class="current edgtf-mobile-no-link"><span>Le Club</span></a><span
										class="mobile_arrow"><i class="edgtf-sub-arrow bx bxs-chevron-right"></i><i
											class="fa fa-angle-down"></i></span>
									<ul class="sub_menu">
			...
			<div class="edgtf-content">
				<div class="edgtf-content-inner">
					<div class="edgtf-title-holder edgtf-standard-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
						style="height: 350px;box-shadow: 15px 15px 21px 0px rgba(1, 1, 1, 0.3);background-image:url('images site/bg_hof.jpg');"
						data-height="350">
						<div class="edgtf-title-image">
							<img itemprop="image"
								src="images site/bg_hof.jpg"
								alt="a" />
						</div>
						<div class="edgtf-title-wrapper" style="height: 350px">
							<div class="edgtf-title-inner">
								<div class="edgtf-grid">
									<h3 class="edgtf-page-title entry-title">Palmarès</h3>
								</div>
							</div>
						</div>
					</div>
					<section class="vc_section awards-intro vc_custom_1612554870832">
						<div class="edgtf-row-grid-section-wrapper edgtf-row-with-shadow edgtf-content-aligment-center">
							<div class="edgtf-row-grid-section">
								<div class="vc_row wpb_row vc_row-fluid vc_row-o-content-middle vc_row-flex">
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="vc_column-inner" style="padding: 40px 15px;">
											<div class="wpb_wrapper">
												<div
													class="edgtf-row-grid-section-wrapper edgtf-content-aligment-center">
													<div class="edgtf-row-grid-section">
														<div
															class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1612554631163 vc_row-o-content-middle vc_row-flex">
															<div class="wpb_column vc_column_container vc_col-sm-4">
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		<div class="edgtf-counter-holder awards-total">
																			<div class="edgtf-counter-inner">
																				<span
																					class="edgtf-counter edgtf-zero-counter"><?php echo $trophies; ?></span>
															...
															<div class="wpb_column vc_column_container vc_col-sm-4">
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		<div
																			class="edgtf-counter-holder awards-total-first">
																			<div class="edgtf-counter-inner">
																				<span
																					class="edgtf-counter edgtf-zero-counter"><?php echo $firstPlaces; ?></span>
																				<h6 class="edgtf-counter-title">
																					1st Place Awards </h6>
																			</div>
																		</div>
							...
							<div class="edgtf-grid-row">
								<div class="edgtf-page-content-holder edgtf-grid-col-12">
									<div class="edgtf-row-grid-section-wrapper ">
										<div class="edgtf-row-grid-section">
											<div class="vc_row wpb_row vc_row-fluid vc_custom_1529590136832">
												<div
													class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-offset-0 vc_col-lg-12 vc_col-md-offset-0 vc_col-md-12 vc_col-sm-offset-0">
													<div class="vc_column-inner">
														<div class="wpb_wrapper">
															<div class="edgtf-tabs  edgtf-tabs-vertical">
																<!--<button class="language_selector">Select the Year &nbsp;<i style="font-size:12px" class="bx bxs-chevron-down"></i></button>-->
																<ul class="edgtf-tabs-nav languages clearfix" role="tablist">
																	<li>
																		<a href="#tab-trophies">2019 -
																			<script>document.write(new Date().getFullYear());</script>
																		</a>
																	</li>
																	<li>
																		<a href="#tab-achievments">2008 - 2011</a>
																	</li>
																	<li>
																		<a href="#tab-specs">2004 - 2007</a>
																	</li>
																</ul>
																<div class="edgtf-tab-container page-awards-content" id="tab-trophies-401">
																		...
																		<div class="edgtf-match-list-holder edgtf-match-skin-dark"
																			...
																			<table class="table-head">
																				...
																				<tr text-align="left">
																					...
																					<td width="20%" class="text-left">Team</td>
																					<td width="20%" class="text-left">Lieu</td>
																					<td width="34%" class="text-left">Compétition</td>
																					<td width="6%" class="text-left">Position</td>
																				</tr>
																			</tbody>
																			</table>
																			<?php foreach($palmas as $palma): ?>
																			<article
																				class="edgtf-match-status-finished reward">
																				<div class="edgtf-match-item-holder">
																					<table class="mytable"><tr style="">
																						<td width="20%" class="text-left"><div class="edgtf-match-infop">
																							<div
																								class="edgtf-match-date-haf">
																								<span
																									class="edgtf-match-date-haf"><span><?php echo $palma['date']; ?></span></span>
																							</div>
																						</div></td>
																						
																						<td width="20%" class="text-left edgtf-match-title-haf"><img src="images site/jeux/<?php echo $palma['game']; ?>.png" width="22px" alt="Country Logo" style="max-height:14px;">&nbsp;
																							<strong><?php echo $palma['team']; ?></strong>
																					</td>
																					<td width="20%" class="text-left td-position1"><img src="images site/pays/<?php echo $palma['pays']; ?>.png" width="22px" style="max-height:14px;" alt="Country Logo">&nbsp; <?php echo $palma['lieu']; ?></td>


																						<td width="34%" class="text-left">
																							<div class="edgtf-match-infop">
		
																								<h6 class="edgtf-match-title-haf">
																								<?php echo $palma['competition']; ?>   </h6>
		
																							</div></td>	
																						<?php if($palma['position']!=1 && $palma['position']!=2 && $palma['position']!=3):?>
																						<td width="6%" class="td-position3">
																								<strong><?php echo $palma['position']; ?>th</strong>
																					    </td>
																						<?php endif ?>
																						<?php if($palma['position']==3): ?>
																						<td width="3%" class="td-position1"><div
																							class="edgtf-match-stream-holder">
																									<strong >3rd</strong>
																						</div>
																						</td>
																						<td width="3%" class="td-position2">
																							<div
																							class="edgtf-match-stream-holder">
																							<i class="edgtf-social-icon-widget bx bxs-trophy bx-sm" style='color:#cd7f32'></i>
	
																						</div>
																						</td>
																						<?php endif ?>
																						<?php if($palma['position']==2): ?>
																							<td width="3%" class="td-position1"><div
																						class="edgtf-match-stream-holder">
																								<strong >2nd</strong>
																					</div>
																					</td>
																					<td width="3%" class="td-position2" style="padding-right: 2PX;">
																						<div
																						class="edgtf-match-stream-holder">
																						<i class="edgtf-social-icon-widget bx bxs-trophy bx-sm" style='color:#C0C0C0'></i>
																					...
																					<td width="3%" class="td-position2">
																						<div
																						class="edgtf-match-stream-holder">
																						<i class="edgtf-social-icon-widget bx bxs-trophy bx-sm" style='color:#ffd700'></i>

																					</div>
																					</td>
																						<?php endif ?>
																						<?php if($_SESSION['admin']): ?> 
																							<td width="2%" class="td-position2">

																						<div class="edgtf-match-delete" >
																						<a href="hall-of-fame.php?id=<?php echo $palmac['idPalmares']; ?>&delete=1"><i class='bx bxs-trash-alt'></i></a>
																						</div>
																						</td>
																						<?php endif ?>
																...
																<div class="edgtf-tab-container page-awards-content"
																	id="tab-achievments-904">
																					...
																					<table class="mytable"><tr style="">
																						<td width="20%" class="text-left"><div class="edgtf-match-infop">
																							<div
																								class="edgtf-match-date-haf">
																								<span
																									class="edgtf-match-date-haf"><span><?php echo $palmab['date']; ?></span></span>
																							</div>
																						</div></td>
																						
																						<td width="20%" class="text-left edgtf-match-title-haf"><img src="images site/jeux/<?php echo $palmab['game']; ?>.png" width="22px" alt="Country Logo" style="max-height:14px;">&nbsp;
																							<strong><?php echo $palmab['team']; ?></strong>
																					</td>
																					<td width="20%" class="text-left td-position1"><img src="images site/pays/<?php echo $palmab['pays']; ?>.png" width="22px" style="max-height:14px;" alt="Country Logo">&nbsp; <?php echo $palmab['lieu']; ?></td>
																						...
																						<td width="34%" class="text-left">
																							<div class="edgtf-match-infop">
																								...
																								<h6 class="edgtf-match-title-haf">
																								<?php echo $palmab['competition']; ?>   </h6>
		
																							</div></td>	
																						<?php if($palmab['position']!=1 && $palmab['position']!=2 && $palmab['position']!=3):?>
																						<td width="6%" class="td-position3">
																								<strong><?php echo $palmab['position']; ?>th</strong>
																					    </td>
																						<?php endif ?>
																						<?php if($palmab['position']==3): ?>
																						<td width="3%" class="td-position1"><div
																							class="edgtf-match-stream-holder">
																									<strong >3rd</strong>
																						</div>
																...
																<div class="edgtf-tab-container page-awards-content" id="tab-specs-172">
																					...
																					<table class="mytable"><tr style="">
																						<td width="20%" class="text-left"><div class="edgtf-match-infop">
																							<div
																								class="edgtf-match-date-haf">
																								<span
																									class="edgtf-match-date-haf"><span><?php echo $palmac['date']; ?></span></span>
																							</div>
																						</div></td>
																						
																						<td width="20%" class="text-left edgtf-match-title-haf"><img src="images site/jeux/<?php echo $palmac['game']; ?>.png" width="22px" alt="Country Logo" style="max-height:14px;">&nbsp;
																							<strong><?php echo $palmac['team']; ?></strong>
																					</td>
																					<td width="20%" class="text-left td-position1"><img src="images site/pays/<?php echo $palmac['pays']; ?>.png" width="22px" style="max-height:14px;" alt="Country Logo">&nbsp; <?php echo $palmac['lieu']; ?></td>
																						...
																						<td width="34%" class="text-left">
																							<div class="edgtf-match-infop">
																								...
																								<h6 class="edgtf-match-title-haf">
																								<?php echo $palmac['competition']; ?>   </h6>
		
																							</div></td>	
																						<?php if($palmac['position']!=1 && $palmac['position']!=2 && $palmac['position']!=3):?>
																						<td width="6%" class="td-position3">
																								<strong><?php echo $palmac['position']; ?>th</strong>
																					    </td>
																						<?php endif ?>
																						<?php if($palmac['position']==3): ?>
																						<td width="3%" class="td-position1"><div
																							class="edgtf-match-stream-holder">
																									<strong >3rd</strong>
																						</div>
	...
	<script type="text/javascript">
	    var $homeIcon = $('.edgtf-social-icon-widget');
		$(window).resize(function() {
	    (window.innerWidth <= 600){
		    $homeIcon.addClass('bx-xs');
		    $homeIcon.removeClass('bx-sm');
		}
        });
	</script>	
</body>
