                                ...
                                <li id="nav-menu-item-240"
                                    ...
                                    <li id="nav-menu-item-243"
                                        ...
                                        <li id="nav-menu-item-243"
                                            ...
                                            <a href="" class="current"><span class="item_outer"><span class="item_text">The
                                                        Club</span><i
                                                        class="edgtf-menu-arrow fa fa-angle-down"></i></span></a>
                                            <div class="second">
                                                <div class="inner">
                    ...
                    <div class="edgtf-title-holder edgtf-standard-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
                        ...
                        <div class="edgtf-title-wrapper" style="height: 350px">
                            <div class="edgtf-title-inner">
                                <div class="edgtf-grid">
                                    <h3 class="edgtf-page-title entry-title">Our sponsors</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="page-contener">
                            <div class="partner-text">
                                ...
                                <div class="partner-description">
                                    <p><span style="color: white;">CIC</span> is a French bank
                                        supporting companies and numerous associative projects. It
                                        associated with ShockFX Esport to help the launching and the development of the association.</p>
                                </div>
                        ...
                        <div class="page-contener">
                            <div class="partner-text-right">
                                <img src="images site/mywebmaker.png"
                                    class="partner-logo" />
                                <div class="partner-description">
                                    <p>My Web Maker aims to offer you the design of websites, entirely customized and affordable. While offering you an accompaniment of your project from A to Z. </p>
                                </div>
                                <div class="partner-links"><a class="partner-website"
                        ...
                        <div class="page-contener">
                            <div class="partner-text">
                                <img src="images site/lmn8.png"
                                    class="partner-logo" />
                                <div class="partner-description">
                                    <p>LMN8 is the official supplier of ShockFX Esport. Go take a look at <a href="https://eliminate.fr/categorie-produit/shock-fx/">our products</a>.</p>
                                </div>
                                <div class="partner-links"><a class="partner-website"
