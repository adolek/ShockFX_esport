...
<head>
	...
	<title>Hall of fame - ShockFX Esport</title>
												...
												<div class="inner">
                                                    ...
                                                    <a href="roster.php?id=staff"
														...
														<li id="nav-menu-item-1781"
															class="menu-item menu-item-type-post_type menu-item-object-page ">
															<a href="recruitment.php" class=""><span class="item_outer"><span
									...
									<nav class="edgtf-main-menu edgtf-drop-down edgtf-sticky-nav">
										<ul id="menu-main-menu-navigation-1" class="clearfix">
											...
											<li id="sticky-nav-menu-item-244"
												class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children edgtf-active-item has_sub narrow">
												<a href="" class="current"><span class="item_outer"><span
															class="item_text">The Club</span><span class="plus"></span><i
															class="edgtf-menu-arrow fa fa-angle-down"></i></span></a>
						...
						<div class="edgtf-grid">
							<ul id="menu-main-menu-navigation" class="">
								...
								<li id="mobile-menu-item-39"
									...
									<a href="#" class="current edgtf-mobile-no-link"><span>The Club</span></a><span
										class="mobile_arrow"><i class="edgtf-sub-arrow bx bxs-chevron-right"></i><i
											class="fa fa-angle-down"></i></span>
									<ul class="sub_menu">
									...
									<li id="mobile-menu-item-236"
										...
										<li id="mobile-menu-item-237"
											class="menu-item menu-item-type-post_type menu-item-object-product "><a
												href="recruitment.php" class=""><span>Recruitment</span></a></li>
										<li id="mobile-menu-item-1519"
											...
											<a href="hall-of-fame.php"
												class=" edgtf-mobile-no-link"><span>Hall of fame</span></a>
					...
					<div class="edgtf-title-holder edgtf-standard-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
						...
						<div class="edgtf-title-wrapper" style="height: 350px">
							<div class="edgtf-title-inner">
								<div class="edgtf-grid">
									<h3 class="edgtf-page-title entry-title">Hall of fame</h3>
								</div>
							</div>
						</div>
					</div>
																		...
																		<div class="edgtf-match-list-holder edgtf-match-skin-dark"
																			...
																			<table class="table-head">
																				...
																				<tr text-align="left">
																					...
																					<td width="20%" class="text-left">Place</td>
																					<td width="34%" class="text-left">Competition</td>
																					<td width="6%" class="text-left">Result</td>
																				</tr>
																			</tbody>
																			</table>
							...
							<div class="edgtf-grid-col-12">
								...
								<div class="edgtf-container">
									<div class="row">
										<div class="col-md-12">
											<div class="copyright">
												<script>document.write(new Date().getFullYear());</script> &copy; Copyright <strong>ShockFX Esport</strong>. All rights reserved. Website made by <a href="https://mywebmaker.fr">My Web
													Maker</a>.
											</div>
										</div>
									</div>
