...
<html lang="fr">
    ...
    <title>Player - ShockFX Esport</title>
                                                        ...
                                                        <div class="wpb_wrapper">
                                                            <div class="edgtf-section-title-holder  edgtf-st-standard "
                                                                ...
                                                                <div class="edgtf-st-inner">
                                                                    <h4 class="edgtf-st-title">
                                                                        ...
                                                                        <h6 class=""><?php if($membre['poste']=="Joueur"):?><?php echo "Player"; ?><?php endif?>
                                                                            <?php if($membre['poste']!="Joueur"):?><?php echo $membre['poste']; ?><?php endif?></h6>
                                                            ...
                                                            <div class="edgtf-tabs  edgtf-tabs-standard ">
                                                                <ul class="edgtf-tabs-nav clearfix">
                                                                    ...
                                                                    <li>
                                                                        <a href="#tab-achievements">Awards</a>
                                                                    </li>
                                                                </ul>
