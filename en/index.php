...
$sql = "SELECT * FROM `membres` WHERE poste = 'Joueur'";
$result = mysqli_query($db_handle, $sql);
...
<head>
    ...
    <title>Home - ShockFX Esport</title>
                                    ...
                                    <div class="edgtf-divided-left-inner-top-widget-area-inner">
                                        <div id="text-2"
                                            ...
                                            <div class="textwidget">
                                                <p><span style="margin-right:26px">our networks :</span></p>
                                            </div>
                                        </div>
                        ...
                        <div class="edgtf-grid">
                            <ul id="menu-main-menu-navigation" class="">
                                <li id="mobile-menu-item-35"
                                    ...
                                    <a href="index.php" class=" current  edgtf-mobile-no-link"><span>Home</span></a>
                                                            ...
                                                            <div class="edgtf-section-title-holder  edgtf-st-standard ">
                                                                <div class="edgtf-st-inner">
                                                                    <h3 class="edgtf-st-title">
                                                                        Welcome on the <span
                                                                            class="edgtf-st-title-hightlight">new</span>
                                                                         website of </br>ShockFX Esport</h3>
                                                        ...
                                                        <div class="wpb_wrapper">
                                                            <div class="edgtf-section-title-holder  edgtf-st-standard ">
                                                                <div class="edgtf-st-inner">
                                                                    <h3 class="edgtf-st-title">
                                                                        A <span
                                                                            class="edgtf-st-title-hightlight">PLACE</span>
                                                                        TO EXPRESS YOUR TALENTS</h3>
                                                                    <div class="edgtf-st-separator">
                                                                        <svg version="1.1"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                    ...
                                                                    Esports is a sector in constant evolution, but also in undeniable expansion, with a turnover that now exceeds <strong>one billion</strong>  euros each year worldwide. Just like cryptocurrencies or the metaverse, investing in esports is now more than ever a wise choice. 
                                                                    <br/>At <strong>ShockFX Esport</strong> we want to offer our players an environment that will allow them to grow and boost their performance. You are a company looking for more visibility, especially among our youth, and you want to start investing in esport ? <a class="edgtf-social-icon-widget-holder edgtf-icon-has-hover"
                                                
                                                href="contact-us.php" target="_blank">
                                                <span class="edgtf-social-icon-widget">Contact us !</span>
                                            </a></p>
                                                                        ...
                                                                        <div class="vc_empty_space"
                                                                            ...
                                                                            <p class="edgtf-st-text">
                                                                            As you know, the Covid-19 pandemic didn't make things easier, LANs cancellations, etc. We have decided to take advantage of this to advance our projects, in order to offer you the best possible <strong>experience</strong> in the future, thanks to the help we will receive, sponsors, the Normandy region...  
                                                                            <br>You have <strong>skills</strong> but you don't know how to use them, or you want to build new ones? You want to contribute to a solid and exciting project? Do not hesitate to contact us, we are <strong>recruiting</strong> different profiles and talents! You want to launch a team project or contribute to it, but you don't want to do it alone,
                                                                            <a class="edgtf-social-icon-widget-holder edgtf-icon-has-hover"
                                                
                                                href="contact-us.php" target="_blank">
                                                <span class="edgtf-social-icon-widget">let's talk about it !</span>
                                            </a> we will be there to <strong>accompany</strong> you. </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="edgtf-pl-holder edgtf-grid-list edgtf-disable-bottom-space edgtf-standard-layout edgtf-three-columns edgtf-normal-space edgtf-info-below-image">
                                                                ...
                                                                <div class="edgtf-pli edgtf-item-space">
                                                                                ...
                                                                                <div class="edgtf-pli-text-outer">
                                                                                    <div class="edgtf-pli-text-inner">
                                                                                        <div class="edgtf-pli-add-to-cart edgtf-default-skin">
                                                                                            <a rel="nofollow" href="https://eliminate.fr/produit/shock-fx-jersey-2022/" data-quantity="1" data-product_id="197" data-product_sku="004" class="button add_to_cart_button ajax_add_to_cart edgtf-button">See product</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="edgtf-pli-inner">
                                                                            ...
                                                                            <div class="edgtf-pli-text">
                                                                                <div class="edgtf-pli-text-outer">
                                                                                    <div class="edgtf-pli-text-inner">
                                                                                        <div class="edgtf-pli-add-to-cart edgtf-default-skin">
                                                                                            <a rel="nofollow" href="https://eliminate.fr/produit/shock-fx-jersey/" data-quantity="1" data-product_id="197" data-product_sku="004" class="button add_to_cart_button ajax_add_to_cart edgtf-button">See product</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="edgtf-pli-inner">
                                                                            ...
                                                                            <div class="edgtf-pli-text">
                                                                                <div class="edgtf-pli-text-outer">
                                                                                    <div class="edgtf-pli-text-inner">
                                                                                        <div class="edgtf-pli-add-to-cart edgtf-default-skin">
                                                                                            <a rel="nofollow" href="https://eliminate.fr/produit/shock-fx-mug/" data-quantity="1" data-product_id="218" data-product_sku="005" class="button add_to_cart_button ajax_add_to_cart edgtf-button">See product</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="edgtf-pli edgtf-item-space">
                                                                        <div class="edgtf-pli-inner">
                                                                            ...
                                                                            <div class="edgtf-pli-text">
                                                                                <div class="edgtf-pli-text-outer">
                                                                                    <div class="edgtf-pli-text-inner">
                                                                                        <div class="edgtf-pli-add-to-cart edgtf-default-skin">
                                                                                            <a rel="nofollow" href="https://eliminate.fr/produit/shock-fx-masque-afnor/" data-quantity="1" data-product_id="305" data-product_sku="012" class="button add_to_cart_button ajax_add_to_cart edgtf-button">See product</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="edgtf-pli-text-wrapper">
                                                                            <h5 itemprop="name" class="entry-title edgtf-pli-title">
                                                                                <a itemprop="url" href="https://eliminate.fr/produit/shock-fx-masque-afnor/">MasK</a>
                                                                            </h5>
                                                                            <div class="edgtf-pli-price">
                                                                                <!--<del aria-hidden="true">
                                                                ...
                                                                <div class="edgtf-eh-item-content edgtf-eh-custom-2603"
                                                                    ...
                                                                    <div class="edgtf-section-title-holder  edgtf-st-standard edgtf-st-disable-title-break"
                                                                        ...
                                                                        <div class="edgtf-st-inner">
                                                                            ...
                                                                            YOU WISH TO JOIN OUR <br> STRUCTURE ?</h4>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <a itemprop="url"
                                                                        ...
                                                                        <span class="edgtf-btn-text">SEE THE POSITIONS WE ARE LOOKING FOR</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="edgtf-eh-item-inner">
                                                                    <div class="edgtf-eh-item-content edgtf-eh-custom-1746"
                                                                        ...
                                                                        <input class="" type="text" value="" name="nom" placeholder="Your name" id="">
                                                                        <input class="" type="text" value="" name="email" placeholder="Email address" id="">
                                                                        <textarea class="wpcf7-form-control wpcf7-textarea" name="message" id="" placeholder="Your message..." cols="40" rows="10"></textarea> 

                                                                        <div class="edgtf-custom-contact-form">
                                                                        <input type="submit" name="mailform" value="Submit" class="wpcf7-form-control wpcf7-submit">
                                                                        </div>
                                                                        </form>
