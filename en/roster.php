                            ...
                            <div class="edgtf-title-inner">
                                <div class="edgtf-grid">
                                    <h3 class="edgtf-page-title entry-title">
                                        ...
                                        <?php endif?>
                                        <?php if($id=="cr"):?><?php echo "Team clash royale"; ?>
                                        <?php endif?>
                                        <?php if($id=="apex"):?><?php echo "Team apex Legends"; ?>
                                        <?php endif?>
                                        <?php if($id=="fortnite"):?><?php echo "Team fortnite"; ?>
                                        <?php endif?>
                                        <?php if($id=="fifa"):?><?php echo "Team FIFA"; ?>
                                        <?php endif?>
                                        
                                        <?php if($id=="lol"):?><?php echo "Team League of Legends"; ?>
                                        <?php endif?>
                                        <?php if($id=="r6"):?><?php echo "Team Rainbow Six"; ?>
                                        <?php endif?>
                                        <?php if($id=="rl"):?><?php echo "Team Rocket League"; ?>
                                        <?php endif?>
                                        <?php if($id=="csgo"):?><?php echo "Team csgo"; ?>
                                        <?php endif?>
                                        <?php if($id=="hearthstone"):?><?php echo "Team hearthstone"; ?>
                                        <?php endif?>
                                        <?php if($id=="valorant"):?><?php echo "Team Valorant"; ?>
                                        <?php endif?>
                                        <?php if($id=="cod"):?><?php echo "Team Call of Duty"; ?>
                                        <?php endif?>
                                        <?php if($id=="wot"):?><?php echo "Team World of Tanks"; ?>
                                        <?php endif?>
                                                            ...
                                                            <div class="edgtf-team-holder edgtf-team-info-below-image ">
                                                                <div class="edgtf-team-inner">
                                                                    <div class="edgtf-team-image">
                                                                        <a itemprop="url"
                                                                            href="player.php?id=<?php echo $membre['idMembre'];?>"
                                                                            target="_self"></a>
                                                                    ...
                                                                    <div class="edgtf-team-info">
                                                                        ...
                                                                        <p class="edgtf-team-position"><?php if($membre['poste']=="Joueur"):?><?php echo "Player"; ?><?php endif?>
                                                                            <?php if($membre['poste']!="Joueur"):?><?php echo $membre['poste']; ?><?php endif?>
                                                                        </p>
