...
<html lang="fr">
   <head>
    ...
    <title>Contact - ShockFX Esport</title>
	...
	c-1.128,1.022-2.62,1.65-4.258,1.65C6.852,16.716,4,13.864,4,10.358z" />
                        ...
                        <div class="edgtf-grid">
                            <ul id="menu-main-menu-navigation" class="">
                                ...
                                <li id="mobile-menu-item-40"
                                    ...
                                    <a href="contact-us.php" class="current edgtf-mobile-no-link"><span>Contact</span></a>
            ...
            <div class="edgtf-content">
                <div class="edgtf-content-inner">
                    <div class="edgtf-title-holder edgtf-centered-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
                        style="height: 500px;box-shadow: 15px 15px 21px 0px rgba(1, 1, 1, 0.3);background-image:url('images site/contact.jpg');"
                        data-height="500">
                                ...
                                <div class="edgtf-page-content-holder edgtf-grid-col-12">
                                    <div class="edgtf-row-grid-section-wrapper ">
                                        <div class="edgtf-row-grid-section">
                                            <div class="vc_row wpb_row vc_row-fluid vc_custom_1529331312895">
                                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                                    <div class="vc_column-inner">
                                                        <div class="wpb_wrapper">
                                                            <div
                                                                class="edgtf-elements-holder   edgtf-two-columns  edgtf-responsive-mode-1024 ">
                                                                <div class="edgtf-eh-item    "
                                                                    data-item-class="edgtf-eh-custom-8496"
                                                                    data-1367-1600="0 20% 0 0"
                                                                    data-1025-1366="0 20% 0 0"
                                                                    data-769-1024="0 36% 9.5% 0"
                                                                    data-681-768="0 20% 12% 0" data-680="0 0 25% 0">
                                                                    <div class="edgtf-eh-item-inner">
                                                                        <div class="edgtf-eh-item-content edgtf-eh-custom-8496"
                                                                            style="padding: 0.5% 20% 0 0">
                                                                            <div class="edgtf-section-title-holder  edgtf-st-standard "
                                                                                ...
                                                                                <div class="edgtf-st-inner">
                                                                                    ...
                                                                                    <p class="edgtf-st-text"
                                                                                        ...
                                                                                        A question ? A suggestion ? We are here to answer you. Use the form or contact us via our networks below.</p>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="wpb_wrapper">
                                                                                    <span
                                                                                        style="display:inline-block;padding-right: 38px">
                                                                                        <h2 class="edgtf-custom-font-holder  edgtf-cf-6795  "
                                                                                            style="font-family: Rubik;font-size: 13px;line-height: 26px;font-weight: 300;text-transform: lowercase;color: rgba(255,255,255,0.3)"
                                                                                            data-item-class="edgtf-cf-6795">
                                                                                            our networks :</h2>
                                                                                    </span> <span
                                                                                        class="edgtf-icon-shortcode edgtf-normal   "
                                                                                        style="margin: 0 23px 0 0">
                                                                                        <a itemprop="url" class=""
                                                                                            href="https://discord.gg/cn5vmErMVZ"
                                                                                            target="_blank">
                                                                                            <i class="edgtf-icon-font-awesome bx bxl-discord edgtf-icon-element"
                                                                                    ...
                                                                                    <span
                                                                                        ...
                                                                                        style="margin: 0 23px 0 0">
                                                                                        <a itemprop="url" class=""
                                                                                            href="https://twitter.com/ShockfxEsport"
                                                                                            target="_blank">
                                                                                            <i class="edgtf-icon-font-awesome bx bxl-twitter edgtf-icon-element"
                                                                                                style="font-size:13px"></i>
                                                                                        </a>
                                                                                    </span>
                                                                                    <span
                                                                                        ...
                                                                                        style="margin: 0 23px 0 0">
                                                                                        <a itemprop="url" class=""
                                                                                            href="https://www.youtube.com/user/Stephou5430"
                                                                                            target="_blank">
                                                                                            <i class="edgtf-icon-font-awesome bx bxl-youtube edgtf-icon-element"
                                                                                                style="font-size:13px"></i>
                                                                                        </a>
                                                                                    </span>
                                                                                    <span
                                                                                        ...
                                                                                        style="margin: 0 23px 0 0">
                                                                                        <a itemprop="url" class=""
                                                                                            href="https://www.instagram.com/shockfx.esport/"
                                                                                            target="_blank">
                                                                                            <i class="edgtf-icon-font-awesome bx bxl-instagram edgtf-icon-element"
                                                                                                style="font-size:13px"></i>
                                                                                        </a>
                                                                                    </span>
                                                                                    <span
                                                                                        class="edgtf-icon-shortcode edgtf-normal   ">
                                                                                        <a itemprop="url" class=""
                                                                                            href="https://www.twitch.tv/shockfxesport"
                                                                                            target="_blank">
                                                                                            <i class="edgtf-icon-font-awesome bx bxl-twitch edgtf-icon-element"
                                                                                                style="font-size:13px"></i>
                                                                                        </a>
                                                                                    </span>
                                                                                </div>
                                                                ...
                                                                <div class="edgtf-eh-item    "
                                                                    ...
                                                                    data-1367-1600="6px 0 0 0"
                                                                    data-1025-1366="6px 0 0 0" data-769-1024="0 0"
                                                                    data-681-768="0 0" data-680="0 0">
                                                                    <div class="edgtf-eh-item-inner">
                                                                        <div class="edgtf-eh-item-content edgtf-eh-custom-1746"
                                                                            style="padding: 6px 0 0 0">

                                                                            <form method="post" action="contact-us.php" id="form_envoi">
