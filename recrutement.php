...
<head>
	...
	<title>Recrutement - ShockFX Esport</title>
								...
								<li id="mobile-menu-item-39"
									...
									<li id="mobile-menu-item-236"
										...
										<li id="mobile-menu-item-237"
											class="menu-item menu-item-type-post_type menu-item-object-product current-menu-item current_page_item"><a
			...
			<div class="edgtf-content">
				<div class="edgtf-content-inner">
					<div class="edgtf-title-holder edgtf-standard-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
						style="height: 350px;box-shadow: 15px 15px 21px 0px rgba(1, 1, 1, 0.3);background-image:url('images site/recrutement.jpg');"
						data-height="350">
						<div class="edgtf-title-image">
							<img itemprop="image"
								src="images site/recrutement.jpg"
								alt="a" />
						</div>
						<div class="edgtf-title-wrapper" style="height: 350px">
							<div class="edgtf-title-inner">
								<div class="edgtf-grid">
									<h3 class="edgtf-page-title entry-title">Recrutement</h3>
								</div>
							</div>
						</div>
					</div>
                                            ...
                                            <div class="edgtf-section-title-holder  edgtf-st-standard ">
                                                <div class="edgtf-st-inner">
                                                    ...
                                                    <p class="edgtf-st-text">
                                                        Vous souhaitez savoir si des postes sont disponibles, et si oui lesquels ? Pour cela, 
                                                    <a class="edgtf-social-icon-widget-holder edgtf-icon-has-hover"
                                
                                                        href="contact-us.php" target="_blank">
                                                        <span class="edgtf-social-icon-widget"> contactez-nous ici </span>
                                                    </a> !</p>
