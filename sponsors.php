...
<head>
    ...
    <title>Sponsors - ShockFX Esport</title>
...
//]]>
    ...
    <link rel="stylesheet" href="assets/css/partenaires.css" media="all" />
                                ...
                                <li id="nav-menu-item-240"
                                    ...
                                    <li id="nav-menu-item-243"
                                        ...
                                        <li id="nav-menu-item-243"
                                            ...
                                            <a href="" class="current"><span class="item_outer"><span class="item_text">Le
                                                        Club</span><i
                                                        class="edgtf-menu-arrow fa fa-angle-down"></i></span></a>
                                            <div class="second">
                                                <div class="inner">
            ...
            <div class="edgtf-content">
                <div class="edgtf-content-inner">
                    <div class="edgtf-title-holder edgtf-standard-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
                        style="height: 350px;box-shadow: 15px 15px 21px 0px rgba(1, 1, 1, 0.3);background-image:url('images site/fond_noir.jpg');"
                        data-height="350">
                        <div class="edgtf-title-image">
                            <img itemprop="image"
                                src="images site/fond_noir.jpg"
                                alt="a" />
                        </div>
                        <div class="edgtf-title-wrapper" style="height: 350px">
                            <div class="edgtf-title-inner">
                                <div class="edgtf-grid">
                                    <h3 class="edgtf-page-title entry-title">Nos partenaires</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="partner-card"
                        style="background: #09090a url('images site/cic-degrade.png') center no-repeat;">
                        <div class="page-contener">
                            <div class="partner-text">
                                <img src="images site/cic-slider.png"
                                    class="partner-logo" />
                                <div class="partner-description">
                                    <p>Le <span style="color: white;">CIC</span> est une banque française
                                        accompagnant les entreprises et de nombreux projets associatifs. Elle
                                        s’est associée à ShockFX Esport pour aider au lancement et au développement de la structure.</p>
                                </div>
                                <div class="partner-links"><a class="partner-website"
                                        href="https://www.cic.fr">https://www.cic.fr</a>
                                    <div class="partner-social-media"><a
                                            href="https://www.facebook.com/cic/" class="link-social bx bxl-facebook"></a> <a
                                            href="https://twitter.com/cic" class="link-social bx bxl-twitter"></a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="partner-card"
                        style="background: #000000 url('images site/myweb-degrade.png') center no-repeat;">
                        <div class="page-contener">
                            <div class="partner-text-right">
                                <img src="images site/mywebmaker.png"
                                    class="partner-logo" />
                                <div class="partner-description">
                                    <p>My Web Maker a pour vocation de vous proposer la conception de sites web, réalisés entièrement sur mesure et à des tarifs abordables. Tout en vous offrant un accompagnement de votre projet de A à Z. </p>
                                </div>
                                <div class="partner-links"><a class="partner-website"
                                        href="https://www.mywebmaker.fr">https://www.mywebmaker.fr</a>
                                                                    </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="partner-card"
                        style="background: #09090a url('images site/lmn8-degrade.png') center no-repeat;">
                        <div class="page-contener">
                            <div class="partner-text">
                                <img src="images site/lmn8.png"
                                    class="partner-logo" />
                                <div class="partner-description">
                                    <p>LMN8 est l'équipementier officiel de ShockFX Esport. Allez jetez un coup d'oeil à <a href="https://eliminate.fr/categorie-produit/shock-fx/">nos produits</a>.</p>
                                </div>
                                <div class="partner-links"><a class="partner-website"
                                        href="https://eliminate.fr/">https://eliminate.fr/</a>
                                    <div class="partner-social-media"><a href="https://www.facebook.com/eliminateFR/"
                                            class="link-social bx bxl-facebook"></a> <a href="https://twitter.com/eliminate_fr"
                                            class="link-social bx bxl-twitter"></a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
