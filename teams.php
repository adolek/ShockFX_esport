...
<html lang="fr">
  ...
  <head>
    ...
    <title>Equipes - ShockFX Esport</title>
...
<![endif]-->
    ...
    <link rel="canonical" href="https://mywebmaker.fr/shockfx/teams" />
    <link rel='shortlink' href='https://mywebmaker.fr/shockfx/teams'/>
            ...
            <div class="edgtf-content">
                <div class="edgtf-content-inner">
                    <div class="edgtf-title-holder edgtf-standard-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
                        style="height: 350px;box-shadow: 15px 15px 21px 0px rgba(1, 1, 1, 0.3);background-image:url('images site/teams.jpg');"
                        data-height="350">
                        <div class="edgtf-title-image">
                            <img itemprop="image"
                                src="images site/teams.jpg"
                                alt="a" />
                        </div>
                        <div class="edgtf-title-wrapper" style="height: 350px">
                            <div class="edgtf-title-inner">
                                <div class="edgtf-grid">
                                    <h3 class="edgtf-page-title entry-title">Nos équipes</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="edgtf-page-content-holder edgtf-grid-col-12">
                                    <div class="edgtf-row-grid-section-wrapper ">
                                        <div class="edgtf-row-grid-section">
                                            <div class="vc_row wpb_row vc_row-fluid vc_custom_1528809634801">
                                            ...
                                            <?php foreach($games as $game):?>    
                                                    ...
                                                    <div class="vc_column-inner">
                                                        <div class="wpb_wrapper">
                                                            <div
                                                                class="edgtf-iwt clearfix  edgtf-iwt-icon-top edgtf-iwt-icon-medium">
                                                                <div class="edgtf-iwt-icon">
                                                                    <a itemprop="url" href="roster.php?id=<?php echo $game['abr']; ?>" target="_self">
                                                                        <img width="2000" height="348"
                                                                            src="images site/<?php echo $game['abr']; ?>.png"
                                                                ...
                                                                <div class="edgtf-iwt-content">
                                                                    <h6 class="edgtf-iwt-title"
                                                                        ...
                                                                        <a itemprop="url" href="roster.php?id=<?php echo $game['abr']; ?>" target="_self">
                                                                            <span class="edgtf-iwt-title-text"><?php echo $game['nom']; ?></span>
                                                                        </a>
                                                                    </h6>
                                                                </div>
                                                            </div>
