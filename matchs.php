...
<html lang="fr">
   ...
   <head>
    ...
    <title>Les matchs - ShockFX Esport</title>
                ...
                <div class="edgtf-content-inner">
                    <div class="edgtf-title-holder edgtf-standard-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image "
                        ...
                        <div class="edgtf-title-image">
                            <img itemprop="image"
                                src="images site/<?php if($jeu=="bs"):?><?php echo "bs.png\""; ?><?php endif?><?php if($jeu=="cr"):?><?php echo "crx.png\""; ?><?php endif?><?php if($jeu=="wot"):?><?php echo "wotx.png\""; ?><?php endif?><?php if($jeu=="r6"):?><?php echo "r6x.png\""; ?><?php endif?><?php if($jeu=="csgo"):?><?php echo "csgox.png\""; ?><?php endif?><?php if($jeu=="valorant"):?><?php echo "valorantx.png\""; ?><?php endif?><?php if($jeu=="lol"):?><?php echo "lolx.png\""; ?><?php endif?><?php if($jeu=="rl"):?><?php echo "rlx.png\""; ?><?php endif?><?php if($jeu=="fifa"):?><?php echo "fifax.png\""; ?><?php endif?><?php if($jeu=="fortnite"):?><?php echo "fortnitex.png\""; ?><?php endif?><?php if($jeu=="apex"):?><?php echo "apexx.png\""; ?><?php endif?><?php if($jeu=="cod"):?><?php echo "codx.png\""; ?><?php endif?><?php if($jeu=="hearthstone"):?><?php echo "hearthstonex.png\""; ?><?php endif?>
                                                        ...
                                                        <div class="wpb_wrapper">
                                                            <div
                                                                ...
                                                                <ul class="edgtf-tabs-nav clearfix">
                                                                    <li>
                                                                        <a href="#tab-all-matches">Tous les Matchs</a>
                                                                    </li>
                                                                    <li>
