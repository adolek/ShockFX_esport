                    ...
                    <div class="edgtf-title-holder edgtf-centered-type edgtf-title-va-header-bottom edgtf-preload-background edgtf-has-bg-image edgtf-bg-parallax"
                        ...
                        <div class="edgtf-title-wrapper" style="height: 500px">
                            <div class="edgtf-title-inner">
                                <div class="edgtf-grid">
                                    <h3 class="edgtf-page-title entry-title">Contactez-nous !</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                                                            ...
                                                                            <div class="edgtf-section-title-holder  edgtf-st-standard "
                                                                                ...
                                                                                <div class="edgtf-st-inner">
                                                                                    ...
                                                                                    <p class="edgtf-st-text"
                                                                                        ...
                                                                                        Une question ? Une suggestion ? Nous sommes présents pour vous répondre. Utilisez le formulaire ou contactez-nous via nos réseaux ci-dessous.</p>
                                                                                </div>
                                                                            </div>
